...
import { sampleWithRequiredData } from '../ranking.test-samples';
...
describe('Ranking Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to rankingService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getRankingIdentifier');
      const id = comp.trackId(entity);
      expect(service.getRankingIdentifier).toHaveBeenCalledWith(entity);
