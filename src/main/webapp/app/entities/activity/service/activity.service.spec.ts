...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../activity.test-samples';

import { ActivityService, RestActivity } from './activity.service';

const requireRestSample: RestActivity = {
  ...sampleWithRequiredData,
  activityDate: sampleWithRequiredData.activityDate?.toJSON(),
