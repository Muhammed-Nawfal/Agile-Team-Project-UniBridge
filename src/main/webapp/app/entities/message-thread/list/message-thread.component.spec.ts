...
import { sampleWithRequiredData } from '../message-thread.test-samples';
...
describe('MessageThread Management Component', () => {
  let comp: MessageThreadComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(MessageThreadComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.messageThreads?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to messageThreadService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getMessageThreadIdentifier');
      const id = comp.trackId(entity);
      expect(service.getMessageThreadIdentifier).toHaveBeenCalledWith(entity);
