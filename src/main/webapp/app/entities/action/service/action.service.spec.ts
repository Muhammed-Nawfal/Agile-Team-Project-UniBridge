...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../action.test-samples';

import { ActionService, RestAction } from './action.service';

const requireRestSample: RestAction = {
...
describe('Action Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Action', () => {
      const action = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(action).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Action', () => {
      const action = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(action).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addActionToCollectionIfMissing', () => {
      it('should add a Action to an empty array', () => {
        const action: IAction = sampleWithRequiredData;
      ...
      it("should add a Action to an array that doesn't contain it", () => {
        const action: IAction = sampleWithRequiredData;
        const actionCollection: IAction[] = [sampleWithPartialData];
        expectedResult = service.addActionToCollectionIfMissing(actionCollection, action);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(action);
      });
      ...
      it('should add only unique Action to an array', () => {
        const actionArray: IAction[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const actionCollection: IAction[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const action: IAction = sampleWithRequiredData;
        const action2: IAction = sampleWithPartialData;
    ...
    describe('compareAction', () => {
      it('Should return true if both entities are null', () => {
        ...
        const compareResult = service.compareAction(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareAction(entity1, entity2);
        const compareResult2 = service.compareAction(entity2, entity1);
