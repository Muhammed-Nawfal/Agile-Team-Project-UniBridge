...
import { sampleWithRequiredData } from '../action.test-samples';
...
describe('Action Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to actionService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getActionIdentifier');
      const id = comp.trackId(entity);
      expect(service.getActionIdentifier).toHaveBeenCalledWith(entity);
