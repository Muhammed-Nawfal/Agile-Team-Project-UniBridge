...
interface UserMessage {
  ...
  time: string;
  type: 'sent' | 'received';
  // Added containsProfanity flag to track filtered messages
...
export class ChatComponent implements OnInit, AfterViewChecked {
  ...
  // Added profanity filter list (matches the Java backend list)
  // This provides client-side filtering before sending to the server
  ...
  // Added method to check for profanity in text
  ...
  // Added method to filter profanity from text
  ...
  sendMessage(): void {
    ...
    // Apply filter if necessary and create sent message
    ...
    const sentMessage: UserMessage = {
      ...
      type: 'sent',
      containsProfanity: hasProfanity, // Flag message as containing profanity
    };
    ...
    setTimeout(() => {
      ...
      const receivedMessage: UserMessage = {
        ...
        time: this.generateFormattedTime(),
        type: 'received',
        containsProfanity: false, // Predefined responses don't contain profanity
      };
