...
import bham.team.repository.LocationRepository;
...
/**
 * REST controller for managing {@link bham.team.domain.Location}.
 */
@RestController
        ...
        Optional<Location> result = locationRepository
            ...
            .map(existingLocation -> {
                ...
                if (location.getRemainingCapacity() != null) {
                    existingLocation.setRemainingCapacity(location.getRemainingCapacity());
                }
                if (location.getIsCapacityBased() != null) {
                    existingLocation.setIsCapacityBased(location.getIsCapacityBased());
                }
