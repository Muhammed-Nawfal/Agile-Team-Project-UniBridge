...
import static bham.team.domain.LocationAsserts.*;
...
class LocationResourceIT {
    ...
    private static final Boolean DEFAULT_IS_CAPACITY_BASED = false;
    private static final Boolean UPDATED_IS_CAPACITY_BASED = true;
    ...
    public static Location createEntity() {
        return new Location()
            ...
            .isCapacityBased(DEFAULT_IS_CAPACITY_BASED);
    }
    ...
    public static Location createUpdatedEntity() {
        return new Location()
            ...
            .isCapacityBased(UPDATED_IS_CAPACITY_BASED);
    }
    ...
    @Test
    @Transactional
    void checkIsCapacityBasedIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        location.setIsCapacityBased(null);
    ...
    void getAllLocations() throws Exception {
        ...
        restLocationMockMvc
            ...
            .andExpect(jsonPath("$.[*].isCapacityBased").value(hasItem(DEFAULT_IS_CAPACITY_BASED.booleanValue())));
    }
    ...
    void getLocation() throws Exception {
        ...
        restLocationMockMvc
            ...
            .andExpect(jsonPath("$.isCapacityBased").value(DEFAULT_IS_CAPACITY_BASED.booleanValue()));
    }
    ...
    void partialUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.status(UPDATED_STATUS).capacity(UPDATED_CAPACITY).remainingCapacity(UPDATED_REMAINING_CAPACITY);
