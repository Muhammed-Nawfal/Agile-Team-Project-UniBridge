...
class NotificationResourceIT {
    ...
    private static final Notificationstype DEFAULT_NOTIFICATION_TYPE = Notificationstype.NEW_CHAT_MESSAGE;
    private static final Notificationstype UPDATED_NOTIFICATION_TYPE = Notificationstype.FRIEND_REQUEST;
    ...
    void partialUpdateNotificationWithPatch() throws Exception {
        ...
        partialUpdatedNotification.title(UPDATED_TITLE);
