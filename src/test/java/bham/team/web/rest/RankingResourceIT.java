...
import static bham.team.domain.RankingAsserts.*;
...
class RankingResourceIT {
    ...
    public static Ranking createEntity() {
        return new Ranking()
            ...
            .starAverage(DEFAULT_STAR_AVERAGE)
    ...
    public static Ranking createUpdatedEntity() {
        return new Ranking()
            ...
            .starAverage(UPDATED_STAR_AVERAGE)
    ...
    @Test
    @Transactional
    void checkReviewNumberIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        ranking.setReviewNumber(null);

        // Create the Ranking, which fails.
    ...
    void checkActivityNumberIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        ranking.setActivityNumber(null);
    ...
    @Test
    @Transactional
    void checkStarAverageIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        ranking.setStarAverage(null);
    ...
    @Test
    @Transactional
    void checkReliableIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        ranking.setReliable(null);
