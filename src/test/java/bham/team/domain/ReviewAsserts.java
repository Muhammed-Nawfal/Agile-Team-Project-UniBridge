...
public class ReviewAsserts {
    ...
    public static void assertReviewUpdatableFieldsEquals(Review expected, Review actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getDatePublished()).as("check datePublished").isEqualTo(actual.getDatePublished()))
            .satisfies(e -> assertThat(e.getStar()).as("check star").usingComparator(bigDecimalCompareTo).isEqualTo(actual.getStar()))
    ...
    public static void assertReviewUpdatableRelationshipsEquals(Review expected, Review actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getAboutUser()).as("check aboutUser").isEqualTo(actual.getAboutUser()))
            .satisfies(e -> assertThat(e.getFromUser()).as("check fromUser").isEqualTo(actual.getFromUser()));
    }
}
